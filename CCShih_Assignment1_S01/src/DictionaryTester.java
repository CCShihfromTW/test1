...
class DictionaryTester {
    ...
    void testMatchCase() {
        ...
        testArray.clear();
        testArray.add("Bookable [adjective] : Can be ordered in advance.");
    ...
    void testErrors() {
        ...
        assertEquals(testArray, d.querryDictionary("Bookable", "book", true), "Check your error format");
        assertEquals(testArray, d.querryDictionary("Pronoun", "reverb", false), "Check your error format");
        testArray.clear();
